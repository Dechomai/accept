...
export const createService = (service, files, primaryPhotoIndex) => dispatch => {
  ...
  return serviceService.createService(service, files, primaryPhotoIndex).then(
...
export const updateService = (service, serviceId, primaryPhotoIndex) => dispatch => {
  ...
  return serviceService.updateService(service, serviceId, primaryPhotoIndex).then(
...
export const fetchServiceById = serviceId => dispatch => {
  ...
  return serviceService.getServiceById(serviceId).then(
